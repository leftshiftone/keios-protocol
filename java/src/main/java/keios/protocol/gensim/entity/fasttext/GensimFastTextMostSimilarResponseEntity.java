 ...
 * @author Michael Mair
 */
public class GensimFastTextMostSimilarResponseEntity implements Message {
    ...
    @Override
    public GensimMessageEntity.MessageType type() {
        return GensimMessageEntity.MessageType.FASTTEXT_MOST_SIMILAR_RESPONSE;
    }
